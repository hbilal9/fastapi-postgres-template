...
EMAIL_VERIFICATION_REQUIRED_ERROR = (
    "Email verification required. Please check your email inbox and verify your account."  # nosec
)
TWOFA_REQUIRED_ERROR = "MFA token required or invalid"  # nosec
INVALID_VERIFICATION_TOKEN_ERROR = "Invalid verification token"  # nosec
VERIFICATION_TOKEN_EXPIRED_ERROR = (
    "Verification token expired. "
    "A new token has been sent to your email."  # nosec
)
